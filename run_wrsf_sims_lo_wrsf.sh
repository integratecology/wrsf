...
if [ -f results/final/wrsf_sim_results_lo_wrsf.csv ]; then
	echo "Results file already exists! continuing..."
else
	echo "creating results file wrsf_sim_results_lo_wrsf.csv"
	echo "sim_no,samp_freq,wrsf_coef,wrsf_lcl,wrsf_ucl,runtime" > results/final/wrsf_sim_results_lo_wrsf.csv
fi
